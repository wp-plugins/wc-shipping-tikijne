<?php
	...
	function plugin_register(){
	    ...
	    if (extension_loaded('curl')) {
                  $ch = curl_init();
                  curl_setopt($ch, CURLOPT_URL, "http://www.epeken.com/plugin_register/?emailid=".$current_user->user_email."&website=".$url."&plugin=wc_shipping_tikijne&ver=1.2.5.3-free");
